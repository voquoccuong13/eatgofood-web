...
import PizzaItemCart from './PizzaItemCart';
...
const MenuPIzza = () => {
    ...
    useEffect(() => {
        fetch('/api/products?mainCategory=Pizza')
            .then((res) => res.json())
            .then((data) => {
                console.log('Sản phẩm Pizza:', data);
                setPizzaList(data); // nếu bạn dùng state
            });
    }, []);
    return (
            ...
            <div className="bg-primary/5 py-8 px-4 md:px-20 rounded-t-xl">
                <div className="container mx-auto px-4">
                    <div className="flex flex-col md:flex-row items-center justify-between">
                        <div>
                            <h1 className="text-3xl font-bold text-gray-800 mb-2">Pizza</h1>
                            <nav className="flex" aria-label="Breadcrumb">
                                <ol className="inline-flex items-center space-x-1 md:space-x-3">
                                    ...
                                    <li aria-current="page">
                                        <div className="flex items-center">
                                            <i className="ri-arrow-right-s-line text-gray-500"></i>
                                            <span className="ml-1 text-sm font-medium text-primary md:ml-2">Pizza</span>
                                        </div>
                                    </li>
                                </ol>
                            </nav>
